...
(function( $ ) {
	$.fn.simpleSidebar = function( options ) {
		...
		$( 'body' ).append( '<div data-' + dataName + '="mask"'+'class'+'="mask" >'+'</div>' );
		...
		if ( 'left' === align ) {
			...
			$sidebar.on( 'click','.d-btn-sure', $links, animateToRight );
		}
...
$( document ).ready(function() {
	...
	$('#open-sb').click(function(){
		$('.mod_container').addClass('toolbar');
		$('body').addClass('p-r');
		$('html').addClass('p-r');
	});
	$('.d-btn-sure').click(function(){
		$('.mod_container').removeClass('toolbar');
	});
	$(".mask").click(function(){
		$('.mod_container').removeClass('toolbar');
	});
